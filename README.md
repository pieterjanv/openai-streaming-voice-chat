...
4. Send a post request to `/voice` with the a body as described below.
...
| `audio` | string | Base64-encoded audio data in a [format supported by OpenAI's transcription service](https://platform.openai.com/docs/api-reference/audio/createTranscription#audio-createtranscription-file). | none |
| `audioFormat` | string | Format of the audio data. | `'webm'` |
